...
public class FrmPrincipal extends JFrame {
	...
	public static Estudiantes coleccion; //Declaracion de la colecci�n Estudiantes
	...
	public FrmPrincipal() {
		...
		//posici�n y tama�o ventana Principal
